...
const Dashboard = ({ onLogout, onNavigateToWeather, onNavigateToMarket, onNavigateToSettings, onNavigateToSeasonalAdvice, farmerName, currentLanguage, onLanguageChange, t }) => {
